...
public class FileHelper {
    ...
    public static List<Company> readAllCompanies(String fileName) throws IOException {
        ...
        InputStream inputStream = new FileInputStream(("/Users/sarahyoung/cs_projects/gs_ee/stock_visualization copy/caseStudy/services/src/main/resources/data" + File.separatorChar + fileName));
//        InputStream resourceAsStream = FileHelper.class.getClassLoader().getResourceAsStream(fileName);
    ...
    public static List<Stock> readAllStocks(String fileName) throws IOException {
        ...
        InputStream inputStream = new FileInputStream(("/Users/sarahyoung/cs_projects/gs_ee/stock_visualization/caseStudy/services/src/main/resources/data" + File.separatorChar + fileName));
//        InputStream resourceAsStream = FileHelper.class.getClassLoader().getResourceAsStream(fileName);
