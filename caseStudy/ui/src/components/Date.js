            ...
            <div className="date">
                {
                     ...
                     *
                     */
                    <DatePicker dateFormat="MM/DD/YYYY" selected={this.state.date} onChange={this.handleChange.bind(this)} />
                }
                ...
                <div className="date-input">
                  { 
                  //{props:date ? props.date.toString() : null}
                  <p> {this.props.datevar} </p>
